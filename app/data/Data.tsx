    ...
    return (
        <Layout>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 100 }}>
                <Link href="/data/COC" onPress={() => {
                 
                }} >
                    <View style={{ position: "relative", justifyContent: "center", alignItems: "center", margin: 5 }}>
                    <Text style={styles.textWindow}>COC CZ market </Text>
                    <Animated.Image style={{ width: 140, height: 190, opacity: window1 }} source={require("../../assets/window_bez_kridla.png")} />
              
                    </View>
                </Link>
                <Link href="/data/DROV" onPress={() => {
                }} >
                    <View style={{ position: "relative", justifyContent: "center", alignItems: "center", margin: 5 }}>
                    <Text style={styles.textWindow}>Drovelis{"\n"}x{"\n"}Zlynda</Text>
